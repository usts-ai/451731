    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">MenStuffs</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products" className="text-gray-400 hover:text-white">Produits</Link>
              </li>
              <li>
                <Link to="/social" className="text-gray-400 hover:text-white">Réseaux Sociaux</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-white">Montres</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white">Bracelets</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white">Portefeuilles</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white">Lunettes</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white">Accessoires</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Inscrivez-vous pour recevoir nos dernières actualités et promotions.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} MenStuffs. Tous droits réservés.
          </p>
